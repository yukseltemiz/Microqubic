...
#define sensorR PIN_PA6
#define sensorT PIN_PA7
#define LEDpin PIN_PA4 //inverted
#define motorDIAG PIN_PB1
#define SW_RX PIN_PB0
#define SW_TX PIN_PA1
#define motorEN PIN_PA4
#define switchL PIN_PA0
#define switchR PIN_PA3
